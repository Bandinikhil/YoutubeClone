...
dispatch(cacheResults({[searchQuery] : json[1] || []}))
    ...
    return (
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black text-white dark:bg-black">
            {loading && <Loader />}
          ...
          <div className='absolute top-14 text-white to-white bg-black py-2 px-5 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px] shadow-md rounded-lg  outline-none'>
            ...
            <div className="flex items-center">
                ...
                <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
                    <img alt="" src="https://xsgames.co/randomusers/assets/avatars/female/67.jpg" />
                </div>
            </div>
        </div>
    );
